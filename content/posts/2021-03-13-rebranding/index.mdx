...
## Usernames and an online identity
I've decided to change my primary online moniker from `jhthenerd` to `err53`
...
### err53: Apple, gaming, and (hopefully) a longer lasting username
...
I've settled on err53, since it's a bit less commonly registered, and a bit shorter.
